    ...
    public class RegisterValidator : AbstractValidator<RegisterDTO>
    {
        public RegisterValidator() 
        {
            ...
            RuleFor(n => n.Password)
                ...
                .Matches(@"^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{6,}$").WithMessage("Password Contains one Capital letter one small letter and one special letter and number and at least 6 letters");
            ...
            RuleFor(n => n.Salary)
                ...
                .InclusiveBetween(0m,10000m).WithMessage("Salary must be between 0 and 100.00");
